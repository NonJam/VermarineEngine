...
//! To do this we will need to add some code to our init method in our rust native script class
//! ```
//! // --snip
//! // instance is the name of our variable that contains the engine
//! // see the init method in the instance.rs file of the scene-example crate
